    ...
    <LinearGradient colors={['#f7fbfc', '#eef7f8', '#ffffff']} style={styles.background}>
      <SafeAreaView style={styles.container}>
        <LinearGradient colors={['#63B6C5', '#63B6C5', '#63B6C5']} style={styles.headerBar}>
          ...
          <PetOwnerSideDrawer visible={isHeaderMenuVisible} onClose={() => setIsHeaderMenuVisible(false)} navigation={navigation} user={user} activeKey="medical" />
          {false ? (
        ...
        <View style={localStyles.quickAssistFloat}>
          <TouchableOpacity
            style={localStyles.quickAssistTouch}
            onPress={() => navigation.navigate('PetOwnerQuickAssist', { user })}
            activeOpacity={0.88}
            accessibilityRole="button"
            accessibilityLabel="Open Quick Assist"
          >
            <View style={localStyles.quickAssistIconWrap}>
              <Image
                source={require('../../assets/support.png')}
                style={localStyles.quickAssistIcon}
                resizeMode="contain"
              />
            </View>
          </TouchableOpacity>
