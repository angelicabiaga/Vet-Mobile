// Shared parsing helpers for the AI predictive-health text output. Nothing
// here calls the AI or changes its prompt -- these only reformat the
// returned plain text (and real medical-record data) for display in the
// Animal Patient Profile's Medical History and AI Predictive Health tabs.
// Ported from the PawCruz web app (final-vet/src/utils/predictiveHealthParsing.js)
// so both platforms parse the same AI response shape identically.

// The exact section headings the pet-level prompt instructs the model to
...
// Section headings for the single-consultation AI Health Insight prompt --
// separate from the pet-level SECTION_HEADINGS/parseAiReport above.
