...
-- IMPORTANT STATUS SYNC REPAIR (2026-08-09)
-- Also run QUEUE_APPOINTMENT_TWO_WAY_STATUS_SYNC_FIX.sql from this project.
-- It closes stale Waiting/Serving queue entries whenever their linked appointment
-- is Completed/Cancelled and keeps Queue <-> Appointment statuses synchronized.
